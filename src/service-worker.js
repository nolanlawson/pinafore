...
const WEBPACK_PREFIX = 'webpack_assets_'

const ASSETS = `${ASSETS_PREFIX}${timestamp}`
const WEBPACK_ASSETS = `${WEBPACK_PREFIX}${timestamp}`
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    // keep the two latest caches of both webpack and assets because we may need
    ...
    await Promise.all([
      deleteOld(WEBPACK_PREFIX),
      deleteOld(ASSETS_PREFIX)
    ])
