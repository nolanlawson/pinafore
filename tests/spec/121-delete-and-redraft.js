...
test('basic delete and redraft', async t => {
  ...
  await t
    ...
    .expect(getNthStatusContent(1 + 0).innerText).contains('hey ho this is grate')
    .click(getNthStatusOptionsButton(1 + 0))
    ...
    .expect(getNthStatusContent(1 + 0).innerText).contains('hey ho this is great')
})
...
test('image with empty text delete and redraft', async t => {
  ...
  await t
    .hover(getNthStatus(1 + 0))
    .expect(getNthStatusMediaImg(1 + 0).getAttribute('alt')).eql('what a kitteh')
    .click(getNthStatusOptionsButton(1 + 0))
    .click(dialogOptionsOption.withText('Delete and redraft'))
    .expect(modalDialog.hasAttribute('aria-hidden')).notOk()
    ...
    .click(composeModalComposeButton)
    .expect(modalDialog.exists).notOk()
    .expect(getNthStatusContent(1 + 0).innerText).contains('I love this kitteh')
    .expect(getNthStatusMediaImg(1 + 0).getAttribute('alt')).eql('what a kitteh')
})
...
test('image with no alt delete and redraft', async t => {
  ...
  await t
    .hover(getNthStatus(1 + 0))
    .expect(getNthStatusMediaImg(1 + 0).getAttribute('alt')).eql('')
    .click(getNthStatusOptionsButton(1 + 0))
    .click(dialogOptionsOption.withText('Delete and redraft'))
    .expect(modalDialog.hasAttribute('aria-hidden')).notOk()
    .expect(composeModalInput.value).eql('')
    ...
    .click(composeModalComposeButton)
    .expect(modalDialog.exists).notOk()
    .expect(getNthStatusContent(1 + 0).innerText).contains('oops forgot an alt')
    .expect(getNthStatusMediaImg(1 + 0).getAttribute('alt')).eql('lovely kitteh')
})
...
test('privacy and spoiler delete and redraft', async t => {
  ...
  await t
    .hover(getNthStatus(1 + 0))
    .expect(getNthStatusSpoiler(1 + 0).innerText).contains('click to see!')
    .click(getNthStatusOptionsButton(1 + 0))
    .click(dialogOptionsOption.withText('Delete and redraft'))
    .expect(modalDialog.hasAttribute('aria-hidden')).notOk()
    ...
    .click(composeModalComposeButton)
    .expect(modalDialog.exists).notOk()
    .expect(getNthStatusSpoiler(1 + 0).innerText).contains('no really, you should click this!')
})
...
test('delete and redraft reply', async t => {
  ...
  await t
    .hover(getNthStatus(1 + 0))
    .expect(getNthStatusContent(1 + 0).innerText).contains('hey hello')
    .click(getNthReplyButton(1 + 0))
    .typeText(getNthComposeReplyInput(1 + 0), 'hello there admin', { paste: true })
    .click(getNthComposeReplyButton(0))
    .expect(getNthStatus(1 + 0).innerText).contains('@admin hello there admin')
    .click(getNthStatusOptionsButton(1 + 0))
    .click(dialogOptionsOption.withText('Delete and redraft'))
    .expect(modalDialog.hasAttribute('aria-hidden')).notOk()
    ...
    .click(composeModalComposeButton)
    .expect(modalDialog.exists).notOk()
    .expect(getNthStatusContent(1 + 0).innerText).match(/@admin hello there admin\s+oops forgot to say thank you/, {
      timeout: 30000
    })
    .click(getNthStatus(1 + 0))
    .expect(getUrl()).match(/statuses/)
    .expect(getNthStatusContent(1 + 0).innerText).contains('hey hello')
    .expect(getNthStatusContent(1 + 1).innerText).match(/@admin hello there admin\s+oops forgot to say thank you/)
})
...
test('delete and redraft reply within thread', async t => {
  ...
  await t
    .hover(getNthStatus(1 + 0))
    .expect(getNthStatusContent(1 + 0).innerText).contains('this is a thread')
    .click(getNthStatus(1 + 0))
    .expect(getUrl()).match(/statuses/)
    .expect(getNthStatusContent(1 + 0).innerText).contains('this is a thread')
    .click(getNthReplyButton(1 + 0))
    .typeText(getNthComposeReplyInput(1 + 0), 'heyo', { paste: true })
    .click(getNthComposeReplyButton(0))
    .expect(getNthStatus(1 + 1).innerText).contains('@admin heyo')
    .click(getNthStatusOptionsButton(1 + 1))
    .click(dialogOptionsOption.withText('Delete and redraft'))
    .expect(modalDialog.hasAttribute('aria-hidden')).notOk()
    .typeText(composeModalInput, ' update!', { paste: true })
    .click(composeModalComposeButton)
    .expect(modalDialog.exists).notOk()
    .expect(getNthStatusContent(1 + 1).innerText).match(/@admin heyo\s+update!/, {
      timeout: 30000
    })
    .expect(getNthStatus(1 + 2).exists).notOk()
})
...
test('multiple paragraphs', async t => {
  ...
  await t
    .hover(getNthStatus(1 + 0))
    .expect(getNthStatusContent(1 + 0).innerText).contains(text)
    .click(getNthStatusOptionsButton(1 + 0))
    .click(dialogOptionsOption.withText('Delete and redraft'))
    .expect(modalDialog.hasAttribute('aria-hidden')).notOk()
