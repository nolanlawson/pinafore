...
test('reblogs a status', async t => {
  ...
  await t
    ...
    .expect(getNthStatusContent(1 + 0).innerText).contains('should be reblogged')
    .expect(getNthReblogged(1 + 0)).eql('false')
    .click(getNthReblogButton(1 + 0))
    .expect(getNthReblogged(1 + 0)).eql('true')
...
test('unreblogs a status', async t => {
  ...
  await t
    .hover(getNthStatus(1 + 0))
    .expect(getNthStatusContent(1 + 0).innerText).contains('woot i wanna')
    .expect(getNthReblogged(1 + 0)).eql('false')
    .click(getNthReblogButton(1 + 0))
    .expect(getNthReblogged(1 + 0)).eql('true')
    .click(getNthReblogButton(1 + 0))
...
test('Keeps the correct reblogs count', async t => {
  ...
  await t
    .hover(getNthStatus(1 + 0))
    .expect(getNthStatusContent(1 + 0).innerText).contains('this will be reblogged')
    .expect(getNthReblogged(1 + 0)).eql('true')
